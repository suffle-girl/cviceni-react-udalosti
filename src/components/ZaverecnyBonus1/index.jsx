...
export const ZaverecnyBonus1 = () => {
  const potvrzeni = (event) => {
    const potvrd = confirm(
      "Opravdu chcete přejít na jinou stránku? Přijdete tak o rozdělanou práci."
    );
  ...
  return (
    <>
      Odkaz:{" "}
      <a onClick={potvrzeni} href="https://www.czechitas.cz/">
        www.czechitas.cz
      </a>
      <hr />
      Formulář:
